...
public class OverlappingChecker {
    public static boolean isScreeningOverlapsWithAnOtherScreening(ScreeningRepo screeningRepo,
    ...
    public static boolean isScreeningOverlapsWithBreakTime(ScreeningRepo screeningRepo,
                                                           Room roomOfScreening,
                                                           LocalDateTime timeOfScreening) {
        for (Screening s : screeningRepo.findAll()) {
            if (s.getRoomOfScreening().equals(roomOfScreening)) {
